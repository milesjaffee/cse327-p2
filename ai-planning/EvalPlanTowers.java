...
class EvalPlanTowers {
    public static void main(String[] args) {
        ...
        final Atom[] initialState3 = {
            ...
            new Atom(On, disk1, disk2), new Atom(On, disk2, disk3), new Atom(On, disk3, rod1),
            new Atom(Clear, disk1), new Atom(Clear, rod2), new Atom(Clear, rod3),
            new Atom(Larger, disk2, disk1), new Atom(Larger, disk3, disk2), new Atom(Larger, disk3, disk1),
        ...
        final Literal[] goalState3 = {
            new Literal(On, disk1, disk2), new Literal(On, disk2, disk3), new Literal(On, disk3, rod3),
            //new Literal(Clear, disk1), new Literal(Clear, rod1), new Literal(Clear, rod2),
        };

        PlanningProblem towersThreeDisks = new PlanningProblem(initialState3, goalState3, towerActions);
        System.out.println("Initial State: ");
        for (Atom a: initialState3) {
            System.out.println(a);
        }
        System.out.println("Goal State: ");
        for (Literal l: goalState3) {
